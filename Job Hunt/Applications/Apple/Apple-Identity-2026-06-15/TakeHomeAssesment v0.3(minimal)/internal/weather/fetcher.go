...
// This class is responsible for fetching the 3 weather APIs in sequence to
...
func (r *RandomLocationFetcher) GetLocation(ctx context.Context) (LocationInfo, error) {
	...
	if err != nil {
		...
		return LocationInfo{}, fmt.Errorf("Error while calling the random location APIError:%v", err)
	}
